...
template <> constexpr inline auto AdminWidget::qt_create_metaobjectdata<qt_meta_tag_ZN11AdminWidgetE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "AdminWidget",
        "loadDatabaseRequested",
        "",
        "saveDatabaseRequested",
...
void AdminWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->loadDatabaseRequested(); break;
        case 1: _t->saveDatabaseRequested(); break;
        case 2: _t->onExportAnalyticsClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AdminWidget::*)()>(_a, &AdminWidget::loadDatabaseRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AdminWidget::*)()>(_a, &AdminWidget::saveDatabaseRequested, 1))
            return;
    }
}
